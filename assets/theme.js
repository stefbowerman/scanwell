...
theme.Product = (function() {
  ...
  function Product(container) {
    ...
    this.zoomEnable = this.$container.data('image-zoom-enable');
    if (this.zoomEnable) {
  ...
  Product.prototype = $.extend({}, Product.prototype, {
    ...
    initSlider: function() {
      ...
      $productSlideshow.slick({
        ...
        customPaging: function(slider, i) {
            ...
            return '<img src="'+thumb+'" role="tab" alt="">';
        }
      });
    ...
    productImageZoom: function() {
      ...
      $(selectors.productImage, this.$container).magnificPopup({
        type: 'image',
        mainClass: 'mfp-fade',
        closeOnBgClick: true,
...
theme.Instagram = (function() {
  function Instagram(container) {
    ...
    var userFeed = new Instafeed({
      ...
      template: '<a href="{{link}}" target="_blank" style="background-image: url({{image}});" class="grid__item instagram--square '+instafeedEl.attr('data-grid')+'"></a>',
      limit: 24,
...
theme.cartTotals = function() {
  var total = 0;
  $('[data-line-item]').each(function() {
    var quantity = $(this).find('[data-line-quantity]').val();
    var price = $(this).find('[data-line-price]').attr('data-line-price');
    var lineTotal = price * quantity
    $(this).find('[data-line-total]')
      .html(slate.Currency.formatMoney(lineTotal, theme.moneyFormat));
    total = total + lineTotal;
  });
  $('[data-cart-total]').html(slate.Currency.formatMoney(total, theme.moneyFormat));
}
